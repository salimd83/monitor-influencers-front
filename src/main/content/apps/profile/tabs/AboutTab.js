...
class AboutTab extends Component {
    ...
    render() {
        ...
        return (<div className={classNames(classes.root, 'md:flex max-w-2xl')}>
            <div className="flex flex-col flex-1 md:pr-32">
                ...
                >
                    {!_.isEmpty(profile) && (<Card className="w-full mb-16">
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProdps)(AboutTab))
