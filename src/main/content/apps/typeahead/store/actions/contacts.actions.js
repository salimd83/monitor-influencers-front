...
export function getContacts(routeParams) {
  const request = Fn.simpleCall('get', 'si/leaderboard?', routeParams);
...
export function addContact(newContact) {
  return (dispatch, getState) => {
    ...
    const request = Fn.simpleCall('post', 'typeahead', newContact);
...
export function getContacts (routeParams) {
	...
	const request = Fn.simpleCall("get", "typeahead/all", routeParams)
...
>>>>>>> f7e0af614d966930ea2ffc8df2795f4100b866b0
}
