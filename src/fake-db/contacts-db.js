...
mock.onGet("/api/contacts-app/contacts")
    .reply((config) => {
...
mock.onGet("/api/contacts-app/user")
    .reply((config) => {
	    return [200, contactsDB.user[0]]
    })

mock.onPost("/api/contacts-app/add-contact")
    .reply((request) => {
...
mock.onPost("/api/contacts-app/update-contact")
    .reply((request) => {
	    const data = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/remove-contact")
    .reply((request) => {
	    const data = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/remove-contacts")
    .reply((request) => {
	    const data          = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/toggle-starred-contact")
    .reply((request) => {
	    const data                 = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/toggle-starred-contacts")
    .reply((request) => {
	    const data                 = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/set-contacts-starred")
    .reply((request) => {
	    const data = JSON.parse(request.data)
...
mock.onPost("/api/contacts-app/set-contacts-unstarred")
    .reply((request) => {
	    const data = JSON.parse(request.data)
