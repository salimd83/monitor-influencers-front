...
mock.onPost("/api/mail-app/update-mail")
    .reply((request) => {
...
mock.onGet("/api/mail-app/filters")
    .reply(200, mailDB.filters)
mock.onGet("/api/mail-app/labels")
    .reply(200, mailDB.labels)
mock.onGet("/api/mail-app/folders")
    .reply(200, mailDB.folders)


mock.onPost("/api/mail-app/set-folder")
    .reply((request) => {
...
mock.onPost("/api/mail-app/toggle-label")
    .reply((request) => {
	    const data                       = JSON.parse(request.data)
...
mock.onPost("/api/mail-app/delete-mails")
    .reply((request) => {
	    const data              = JSON.parse(request.data)
